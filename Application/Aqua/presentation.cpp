<<<<<<< HEAD:Application/Aqua/Aqua/presentation.cpp
...
{
	cout << "\n--------------------------\n";
	cout << "Stations in The Black Sea" << endl;
	cout << "--------------------------\n";
...
{
	cout << "\n-----------------------------------\n";
	cout << "Types of dolphins in The Black Sea" << endl;
	cout << "-----------------------------------\n";
...
void showDolphinTypesMenu()
{
	...
	cout << "2 - Common dolphin" << endl;
	cout << "3 - Harbor porpoises" << endl;
>>>>>>> cc34339f3ec76a50e32219fd0909793e2252f1f3:Application/Aqua/presentation.cpp
}